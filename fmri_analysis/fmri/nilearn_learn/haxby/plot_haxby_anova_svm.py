...
url: http://nilearn.github.io/auto_examples/02_decoding/plot_haxby_anova_svm.html#sphx-glr-auto-examples-02-decoding-plot-haxby-anova-svm-py
"""
...
import numpy as np
session_target_filename = r'D:\FF120\workspace\Python\code\fmri\nilearn_learn\haxby2001_simple\pymvpa-exampledata\attributes.txt'
conditions_target_filename = r'D:\FF120\workspace\Python\code\fmri\nilearn_learn\haxby2001_simple\pymvpa-exampledata\attributes_literal.txt'
y, session = np.loadtxt(session_target_filename).astype("int").T
conditions = np.recfromtxt(conditions_target_filename)['f0']
